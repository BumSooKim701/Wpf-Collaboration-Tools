...
public class TermDateTimeConverter : IMultiValueConverter
{
    ...
    public object Convert(object[] values, Type targetType, object parameter, CultureInfo culture)
    {
        ...
        string startDateTimeStr = FormatDateTime(start, isAllDayEvent);
        string endDateTimeStr = FormatDateTime(end, isAllDayEvent);
    ...
    {
        string dayOfWeek = DayOfWeekKor[(int)dateTime.DayOfWeek];
        string datePart = $"{dateTime.Month}월 {dateTime.Day}일 ({dayOfWeek})";
